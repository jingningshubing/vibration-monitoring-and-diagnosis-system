<template>
  <div ref="chartRef" class="home-diagnosis-trend-chart"></div>
</template>
...
function render() {
  ...
  chart.setOption({
    ...
    xAxis: {
      ...
      axisTick: { show: true },
      axisLabel: { fontSize: 10, color: '#fff', interval: 'auto', rotate: -45, margin: 8 },
      axisLine: { show: true, lineStyle: { color: '#718397' } },
    },
    yAxis: {
      type: 'value', name: '次数', minInterval: 1,
      axisTick: { show: true }, nameTextStyle: { color: '#fff' },
      axisLabel: { fontSize: 10, color: '#fff' },
      axisLine: { show: true, lineStyle: { color: '#718397' } }, splitLine: { show: false },
    },
...
<style scoped>
.home-diagnosis-trend-chart { width: 100%; height: 100%; min-height: 170px; padding-bottom: 6px; }
</style>
