...
该仓库聚焦无人值守监测系统中的**动设备-管线振动监测与辅助诊断**能力，覆盖设备/测点概览、振动数据处理、异常告警、历史查询、诊断结果管理和统计分析。数据接入阶段以 CSV 回放模拟周期采集，便于本地演示与算法验证；现场无线传感器、网关接入等工程化能力还尚需完善。

## 已实现功能

- **设备与测点概览**：结合工艺流程图展示设备、测点位置、在线状态和三轴速度有效值。
