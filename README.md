...
> 本项目用于学习与作品展示。仓库不包含原始振动数据集、运行时波形文件。

## 项目范围

该仓库聚焦无人值守监测系统中的**动设备-管线振动监测与辅助诊断**能力，覆盖设备/测点概览、振动数据处理、异常告警、历史查询、诊断结果管理和统计分析。数据接入阶段以 CSV 回放模拟周期采集，便于本地演示与算法验证；现场无线传感器、网关接入及报告导出等工程化能力还尚需完善。
...
| 系统首页 | 振动预警 |
| --- | --- |
| ![系统首页](图片/首页.jpg) | ![振动预警](图片/振动预警页面.jpg) |
| 波形与频谱详情 | 智能诊断 |
| ![设备历史振动详情](图片/设备历史振动详情页面.jpg) | ![智能诊断](图片/智能诊断页面.jpg) |
